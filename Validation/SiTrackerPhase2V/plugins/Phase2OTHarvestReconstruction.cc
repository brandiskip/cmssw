...
MonitorElement *meD_clus_zoom_barrel = igetter.get(topFolderName_ + "/EfficiencyIngredients/gen_clusters_zoom_barrel");
MonitorElement *meN_clus_endcaps = igetter.get(topFolderName_ + "/EfficiencyIngredients/gen_clusters_if_stub_endcaps");
